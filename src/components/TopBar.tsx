        ...
        <AnimatePresence>
          {showGlobalIcons && (
            <motion.div
              ...
              className="flex items-center gap-1.5 ml-2.5 shrink-0"
            >
              <button
                ...
                className={cn(
                  ...
                  currentPage === "resources"
                    ...
                    : "bg-white border-black/5 hover:border-black/10 text-slate-600 hover:text-slate-900 shadow-xs"
                )}
              >
              ...
              >
                <NotebookPen className="w-4 h-4 stroke-[2]" />
              </button>
            </motion.div>
          )}
        </AnimatePresence>
