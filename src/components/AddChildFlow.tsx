        ...
        <div className={cn(
                ...
                <div className="w-full">
                  ...
                  {isModalOpen && qSection && (
                    <motion.div
                      ...
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
                      className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-10 bg-watercolor bg-fixed"
                    >
          ...
          {step === 'done' && (
            <SetupCompleteStep
              ...
              onViewProfile={() => {
                handleGoToProfile();
                window.requestAnimationFrame(() => onShowReflection?.({
