...
export default function HomePage({
  ...
  const synthesisQuote = isDiagnostic && sessionPreviewUnavailable
    ...
    : (currentChild.isNew || currentChild.name === "Nick" || currentChild.name === "Ava")
  ...
  const progressStatus = (sessionPreviewUnavailable && !isSessionBooked)
    ...
    ? isSessionBooked
      ...
      : "choose your path"
    : (currentChild.name === "Nick" || currentChild.name === "Ava")
  ...
  return (
    ...
    >
      ...
      <PageContainer>
        <PageHeader
        kicker={currentChild.isNew || currentChild.name === "Nick" || currentChild.name === "Ava" ? newChildHomeCopy.kicker : "Tuesday · Good morning"}
        title={currentChild.isNew || currentChild.name === "Nick" || currentChild.name === "Ava" ? newChildHomeCopy.title : isMaintenancePlan ? `${currentChild.name} has completed this quarter's plan.` : "Here's where to put your energy today."}
        titleClassName="md:leading-[4.5rem]"
        className={currentChild.isNew || currentChild.name === "Nick" || currentChild.name === "Ava" ? "mb-12" : "mb-28"}
      />
