...
import greenPlumBedtimeImg from "../assets/images/bedtime_routine_thumbnail_1781935312413.jpg";
import greenPlumClassroomImg from "../assets/images/optimized/classroom-fatigue-900.jpg";
import greenPlumBreathingImg from "../assets/images/optimized/breathing-exercises-900.jpg";
          ...
          <div className="grid grid-cols-2 gap-6 max-md:grid-cols-1 mt-8">
            {previewSections.map((section, index) => {
              ...
              return (
                <div
                  key={section.title}
                  className={`overflow-hidden bg-white ${corners[index]} transition-all duration-300 flex flex-col`}
                >
