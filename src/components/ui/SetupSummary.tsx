          ...
          <div className="thread-setup-summary__status">
            ...
            <div className="thread-setup-summary__steps">
              ...
              <div className="thread-setup-summary__step">
                ...
                <div>
                  <div className="thread-setup-summary__step-label">Step 1</div>
              ...
              <div className="thread-setup-summary__step">
                ...
                <div>
                  <div className="thread-setup-summary__step-label">Step 2</div>
              ...
              <div className="thread-setup-summary__step">
                ...
                <div>
                  <div className="thread-setup-summary__step-label">Step 3</div>
              ...
              <div className={cn(
                ...
                <div className="thread-setup-summary__task-main">
                  ...
                  <div>
                    <div className="thread-setup-summary__step-label">Step 4</div>
              ...
              <div className="thread-setup-summary__step">
                ...
                <div>
                  <div className="thread-setup-summary__step-label">Step 5</div>
                  <div className="thread-setup-summary__step-title">
