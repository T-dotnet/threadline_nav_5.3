...
export function getJourneyHomeCopy(childName: string, journeyStage?: string, reportContext = false) {
  ...
  return {
    ...
    title: `Let's get ${childName}'s Diagnostic Assessment underway.`,
    description:
      'Navigator begins with what you have seen so far, without rushing you into conclusions.',
    quote:
      "The Diagnostic Assessment has three parts: a video call with a clinician, an online questionnaire, and documents to upload. Booking the video call is the first step — we'll help you with the rest.",
