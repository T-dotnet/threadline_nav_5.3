          ...
          <Route path="*" element={
            ...
            >
              <Routes>
                ...
                <Route path="/what-you-noticed" element={currentChild.isNew ? <WhatYouNoticedPage onPageChange={handlePageChange} onOpenSetup={openSetup} onShowPathway={handleShowPathway} /> : <Navigate to="/home" replace />} />
